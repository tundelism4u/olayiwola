			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						<br /><li><a href="products.html">Antidotes‎ </a></li><br />
						
						<li><a href="kitchen.html">Antibody mimetics‎</a></li><br />
						<li><a href="short-codes.html">Short Codes</a></li><br />
						
						<li><a href="pet.html">Anti-infective agents‎ </a></li><br />
						
						<li><a href="bread.html">Antifungal</a></li><br />
					</ul>
				 </div><!-- /.navbar-collapse -->
			</nav>
		</div>
					...
					<ul class="slides">
						<li>
							<div class="w3l_banner_nav_right_banner">
								<h3>Order <span>For</span> Your Drug.</h3>
								<div class="more">
	...
	<div class="footer">
		<div class="container">
			...
			<div class="wthree_footer_copy">
				<p>© 2017 Olayiwola pharmacy. All rights reserved | Design by <a href="http://w3layouts.com/">ADEDOYIN BALIQIS & PARTNER
			</div>
		</div>
	</div>
<!-- //footer -->
